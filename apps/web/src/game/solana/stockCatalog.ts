...
const META: Record<string, Meta> = {
  ...
  BOT:    { name: "RoboStrategy", about: "A Nasdaq-listed fund of robotics and physical AI companies.", sector: "funds", color: "#22D3EE" },
  ...
  RUM:    { name: "RUM Group", about: "Owner of the Rumble video platform and Quake AI cloud.", sector: "tech", color: "#85C742" },
