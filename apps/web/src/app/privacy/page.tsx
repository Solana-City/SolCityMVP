  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 32, fontSize: 11, lineHeight: 1.8, color: "#8888aa" }}>
        ...
        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>1. Overview</h2>
          <p>
        ...
        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>3. Data We Do Not Collect</h2>
        ...
        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>5. Data Retention</h2>
        ...
        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>6. Children</h2>
          <p>Sol City is not directed at children under 13. We do not knowingly collect data from children.</p>
        </section>

        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>7. Changes to This Policy</h2>
        ...
        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>8. Contact</h2>
          <p>
