  ...
  return (
    ...
    >
      <div style={{ marginBottom: 40 }}>
        <div style={{ color: "#9945FF", fontSize: 8, letterSpacing: 3, textTransform: "uppercase", marginBottom: 8 }}>
          The Solana City
        </div>
        <h1 style={{ color: "#ffffff", fontSize: 20, fontWeight: "bold", margin: 0 }}>
          Terms of Service
        </h1>
        <p style={{ color: "#444466", fontSize: 9, marginTop: 8 }}>
          Last updated: May 2025
        </p>
      </div>

      <div style={{ display: "flex", flexDirection: "column", gap: 32, fontSize: 11, lineHeight: 1.8, color: "#8888aa" }}>

        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>1. Acceptance</h2>
        ...
        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>2. The Game</h2>
        ...
        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>3. Wallets &amp; Transactions</h2>
        ...
        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>4. Risks</h2>
        ...
        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>5. Prohibited Conduct</h2>
        ...
        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>6. Intellectual Property</h2>
        ...
        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>7. Disclaimer of Warranties</h2>
        ...
        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>8. Limitation of Liability</h2>
        ...
        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>9. Governing Law</h2>
          <p>These Terms are governed by applicable law. Disputes shall be resolved through binding arbitration where permitted.</p>
        </section>

        <section>
          <h2 style={{ color: "#ccccee", fontSize: 12, marginBottom: 12 }}>10. Contact</h2>
          <p>
            Questions?{" "}
      ...
      <div style={{ marginTop: 64, paddingTop: 24, borderTop: "1px solid rgba(153,69,255,0.15)", color: "#222244", fontSize: 8 }}>
